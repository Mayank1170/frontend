...
export const TradeControls: React.FC = () => {
  ...
  const { trgs, closeTrg, createTrg } = useTRGs();
        ...
        <div className="space-y-4">
            ...
            <div>
              <div className="flex flex-row justify-between w-full">
                <button className="flex flex-row items-center gap-x-2 ">
                  <h1 className="text-2xl font-bold text-white text-opacity-70">
                    +
                  </h1>
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="flex flex-row items-center content-center justify-between">
              <h3 className="text-base font-semibold font-redhat">
                Req. Initial Margin
              </h3>
        ...
        {isPopupVisible && (
          <div className="flex flex-col w-[21%] h-[120px] bottom-[20px] right-[68px]  bg-[black] bg-opacity-30  backdrop-blur-[30px] rounded-lg border border-white border-opacity-30 border-white/20 absolute">
            ...
            <div className="w-[100%] flex flex-col justify-start items-center ">
              <h1 className="text-white w-[90%] opacity-50 text-[13px] 2xl:text-[16px] 3xl:text-[17px] pl-0">
                {popupContent}
              </h1>
              <h2 className="text-white opacity-50 text-[12px]">
                {ConfirmationMessage}
              </h2>
            </div>
          </div>
