  ...
  return (
    <div className="flex flex-row my-2 relative">
      <button onClick={() => setIsOpen((prev) => !prev)} >
        <div className="flex flex-row p-3 items-center justify-center rounded gap-2 " onClick={() => toggleDropdown(1)}
        >
                ...
                <div className="flex flex-col justify-center gap-y-8 ml-5">
                  ...
                  <div className="flex flex-row items-center justify-between gap-x-2 w-full">
                    <div className="flex flex-row items-center gap-x-2">
                      <Image src="/images/Solana.png" width={100} height={100} alt={"solana"} className="w-4 h-4" />
                      <div>Sol-PERP</div>
                    </div>
                    <div className="flex flex-row gap-x-2 items-center mr-4">
                      <h1 className="text-[14px]">$1.7420</h1>
                      <h2 className="text-[11px] text-green-400">+2.64</h2>
                    </div>
                  </div>
                  ...
                  </div> <div className="flex flex-row items-center justify-between gap-x-2 w-full">
                    <div className="flex flex-row items-center gap-x-2">
                      <Image src="/images/Solana.png" width={100} height={100} alt={"solana"} className="w-4 h-4" />
                      <div>Sol-PERP</div>
                    </div>
...
const AdditionalInfoItem: React.FC<AdditionalInfoItemProps> = ({
  ...
  return (
    <div className="flex flex-col">
      <p className="text-white/80 xl:text-[13px] 2xl:text-[18px] text-[24px] font-bold font-redhat">{value}</p>
