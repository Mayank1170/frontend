...
const SearchModal: React.FC<SearchModalProps> = ({ visible, onClick }) => {
    ...
    return (
        <div id='container' onClick={handleOnClose} className="fixed inset-0 z-50 bg-[black] bg-opacity-30 backdrop-blur-sm h-full flex justify-center items-center text-black">
